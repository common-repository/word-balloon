	...
	jQuery(document).ready(function ($) {
		...
		jQuery(document).ready(function ($) {
			...
			for (var i = 0; i < set_item.length; i++) {
				...
				jQuery('#w_b_overlay input.w_b_color_pick[name="' + pre + set_item[i] + after + '"]').val('');
				...
				if (set_item[i] === 'balloon_background_alpha' && restore_data.getAttribute('data-balloon_background_alpha') !== '') {
					//console.log('YES')
					//console.log(result)
					//continue;
				}
